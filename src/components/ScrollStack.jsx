...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      if (hasChanged) {
        const transform = `translateZ(0) translate3d(0, ${newTransform.translateY}px, 0) scale(${newTransform.scale}) rotate(${newTransform.rotation}deg)`;
  ...
  // render: separate window vs. custom scroll
  if (useWindowScroll) {
    return (
